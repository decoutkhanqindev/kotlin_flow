...
fun main(): Unit = runBlocking {
  val channel: Channel<Int> = Channel<Int>(
    capacity = 5, // either a positive channel capacity or one of the constants defined in [Channel.Factory].
    // Channel.RENDEZVOUS // 0 === no buffer
    // Channel.BUFFERED // default is 64 values
    // Channel.CONFLATED // capacity=1 and onBufferOverflow is DROP_OLDEST (1 latest value) ~ StateFlow
